...
describe('Danger', function() {
  ...
  describe('dangerouslyInsertMarkupAt', function() {
    ...
    it('should render markup', function() {
      var markup = (React.DOM.div(null )).mountComponent('.rX', transaction);
    ...
    it('should render markup with props', function() {
      var markup = (React.DOM.div( {className:"foo"} )).mountComponent('.rX', transaction);
      var parent = document.createElement('div');
    ...
    it('should render wrapped markup', function() {
      var markup = (React.DOM.th(null )).mountComponent('.rX', transaction);
      var parent = document.createElement('div');
